            ...
            <div className='px-10'>
                <div className='flex w-full gap-4  items-center py-20 justify-around'>
                    ...
                    <div class="hero_content_wrap ">
                        <div class="text-neutral-400">COMPARISON &gt; TWILIO</div><h1 class="text-5xl font-semibold">The Best Twilio <br />Video Competitor</h1>

                        <div class="feature-flex flex-col">
                            <div class="fill-neutral-100 align-left flex gap-2 ">
                                ...
                                <div class="features-text text-neutral-300 flex">In-built chat, polls, and plugins</div>
                            </div>
                            <div class="fill-neutral-100 align-left flex gap-2">
                                <div class="svg-icon w-embed">
                                ...
                                <div class="features-text">Customizable UI Kit</div>
                            </div>
                            <div class="fill-neutral-100 align-left flex gap-2">
                                <div class="svg-icon w-embed">
                                ...
                                <div class="features-text">No credit card required</div>
                            </div>
                        </div>
                        <div class="hero_cta_wrapper align-left inline-flex gap-8 h-full pt-10 py-4 ">
                            <a data-w-id="18619ab9-ff9a-d30d-7bdd-986a30c0d5c0" href="https://dev.dyte.io/signup" class="cta-btn glossy w-inline-block inline-flex bg-emerald-400 rounded-md text-neutral-900 font-bold  p-4 max-h-[48px] items-center justify-center hover:shadow-[4px_4px_0_1px_#34d399] hover:bg-neutral-100 hover:text-emerald-700 transition-all ease-in-out duration-300 group gap-4 hover:no-underline">

                                <div class="glossy_effect" ></div>
                                <div class="text-block  ">Start building</div>
                                <div class="flex glossy_none_icon w-embed fill-neutral-800 stroke-neutral-800 group-hover:opacity-0 group-hover:hidden">
                                ...
                                <div class="hover_icon w-embed opacity-0 hidden group-hover:opacity-100 group-hover:flex fill-emerald-400 stroke-emerald-400">
                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="inherit" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a href="/contact" class="sec-btn-light w-inline-block inline-flex group gap-4 justify-center items-center ">

                                <div>Talk to an expert</div>

                                <div class="flex glossy_none_icon w-embed  group-hover:opacity-0 group-hover:hidden">
                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="inherit" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className='flex flex-col justify-center items-center py-8 mb-24'>
                    ...
                    <div className=' flex justify-center gap-8 mt-8'>
                        <img src="https://uploads-ssl.webflow.com/63ca2acc6352c221abe583d0/63cf74b0c38394e2bc5d04f3_client-logos-.webp" loading="lazy" alt="dyte client logo" class="client_logo"></img>
                        <img src="https://uploads-ssl.webflow.com/63ca2acc6352c221abe583d0/63ca4e4bdaa24274775cd90b_client-logo-02.svg" loading="lazy" alt="" class="client_logo"></img>
                        <img src="https://uploads-ssl.webflow.com/63ca2acc6352c221abe583d0/63ca4e4bfea0cf714f9736b6_client-logo-03.svg" loading="lazy" alt="" class="client_logo"></img>
                        <img src="https://uploads-ssl.webflow.com/63ca2acc6352c221abe583d0/63ca4e4bdaa242ce715cd949_client-logo-04.svg" loading="lazy" alt="" class="client_logo"></img>
                    </div>
                </div>
                <div className="py-4 flex flex-col justify-center items-center ">
                    <div class="section-head text-center">
                        <div class="text-style-allcaps text-align-center ">WHY DYTE OVER TWILIO VIDEO</div>
                        <h2 class="text-align-center text-4xl ">The Live Video &amp; Voice SDK
                            <br />
                            <span class="text-span"> </span> you have been looking for</h2>
                        <p class="section-subhead">Here are reasons why you should consider Dyte over Twilio Video</p>
                    </div>
                    <div class="features_grid grid grid-cols-2 gap-10 pt-12">
                        <div class="cutomize_medium_card rounded-2xl bg-neutral-800 rounded-2xl bg-neutral-800 ">
                            <div class="big_card_head_wrap p-8 pb-0 p-8 pb-0">
                                <h3 class="big_card_head text-2xl">Custom experience without hassle</h3>
                                <p class="big_card_description _319px_width">Branding, permissions, and custom UI/UX are all a breeze away with our UI Kit.</p>
                            </div>
                        ...
                        <div class="cutomize_medium_card rounded-2xl bg-neutral-800">
                            <div class="big_card_head_wrap p-8 pb-0 ">
                                <h3 class="big_card_head text-2xl">Build more than just video</h3>
                                <p class="big_card_description _319px_width">Create interactive meetings with one-click plugins and built-in chat &amp; polls.</p>
                            </div>
                            <img src="https://uploads-ssl.webflow.com/63ca2acc6352c221abe583d0/63fcbba3127ea415a48983a2_Group%201171275153.svg" loading="lazy" alt="" class="image-5" />
                        </div>
                        <div class="cutomize_medium_card rounded-2xl bg-neutral-800">
                            <div class="big_card_head_wrap p-8 pb-0">
                                <h3 class="big_card_head text-2xl">Reduce development effort</h3>
                                <p class="big_card_description _319px_width">Forget dealing with streams, edge-cases, and writing 1000s of lines of code.</p></div>
                        ...
                        <div class="cutomize_medium_card rounded-2xl bg-neutral-800">
                            <div class="big_card_head_wrap p-8 pb-0">
                                <h3 class="big_card_head text-2xl">Better call completion rates</h3>
                                <p class="big_card_description _319px_width">Ensure your video always runs smoothly no matter the network conditions.</p>
                            </div>
                    ...
                    <div className='py-16'>
                        <a data-w-id="18619ab9-ff9a-d30d-7bdd-986a30c0d5c0" href="https://dev.dyte.io/signup" class="cta-btn glossy w-inline-block inline-flex bg-emerald-400 rounded-md text-neutral-900 font-bold  p-4 max-h-[48px] items-center justify-center hover:shadow-[4px_4px_0_1px_#34d399] hover:bg-neutral-100 hover:text-emerald-700 transition-all ease-in-out duration-300 group gap-4 hover:no-underline">
                            ...
                            <div class="glossy_effect" ></div>
                            <div class="text-block  ">Book a Demo</div>
                            <div class="flex glossy_none_icon w-embed fill-neutral-800 stroke-neutral-800 group-hover:opacity-0 group-hover:hidden">
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="inherit" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M5.33938 1.37116L5.33933 1.37111C5.25663 1.2836 5.15751 1.21324 5.04762 1.16403C4.93774 1.11483 4.81923 1.08776 4.69888 1.08435C4.57853 1.08095 4.45868 1.10128 4.34619 1.14419C4.2337 1.1871 4.13076 1.25175 4.04325 1.33445C3.95574 1.41714 3.88537 1.51626 3.83617 1.62615C3.78697 1.73604 3.75989 1.85454 3.75649 1.97489C3.75308 2.09524 3.77342 2.21509 3.81633 2.32758C3.85923 2.44006 3.92387 2.54298 4.00654 2.63048C4.00656 2.6305 4.00657 2.63051 4.00658 2.63052L9.07909 8.00084L4.00761 13.3714C3.92364 13.4582 3.85767 13.5608 3.81349 13.6733C3.76908 13.7863 3.74757 13.907 3.75022 14.0284C3.75286 14.1498 3.7796 14.2695 3.82889 14.3805C3.87817 14.4915 3.94902 14.5916 4.03732 14.675C4.12561 14.7583 4.22959 14.8233 4.34322 14.8662C4.45684 14.909 4.57785 14.9289 4.69921 14.9246C4.82057 14.9203 4.93987 14.8919 5.05017 14.8411C5.15992 14.7905 5.25858 14.7188 5.34049 14.63L11.006 8.63057C11.006 8.63054 11.006 8.6305 11.006 8.63047C11.1669 8.46029 11.2565 8.23499 11.2565 8.00082C11.2565 7.76664 11.1669 7.54135 11.006 7.37116C11.006 7.37113 11.006 7.3711 11.006 7.37107L5.33938 1.37116Z" fill="inherit" stroke="inherit" stroke-width="0.5"></path>
                                </svg>
                ...
                <div>
                    <div class="ph-card">
                        <div class="space-1">
                            <h3 class="heading-2">No. 1 <br />Product of the day 💫</h3>
                            <p class="cta-subtext">Dyte is the top competitor to Twilio Video SDK that was trusted by 1000+ developers on ProductHunt.</p>
                        </div>
                        <div>
                            <div class="w-embed">
