---
title: "arako - A Fast All-in-One JavaScript Runtime"
desc: "Run, test, transpile, and bundle JavaScript &amp; TypeScript projects — all in Bun. Bun is a new JavaScript runtime built for speed and ease of use."
code: "curl -fsSL https://bun.sh/install{' '} | bash"
link: "https://bun.sh/install"
Tabpanel: 
  tab1: 
    title: "New York"
    desc: "Messages sent per second (Linux x64, 16 clients)"
    youtube: "https://www.youtube.com/embed/cOv1GoWVcY4"
  tab2: 
    title: "Youtube Video About google"
    desc: "Messages sent per second (Linux x64, 16 clients)"
    youtube: "https://www.youtube.com/embed/4WXs3sKu41I"
---
## What is Bun?
...
<Highlight color="#25c2a0">Bun</Highlight> is an all-in-one toolkit for <Highlight color="#ff6524">JavaScript</Highlight> and TypeScript apps. It ships as a single executable called `bun​`.

At its core is the _Bun runtime_, a fast JavaScript <Highlight color="#998524">Runtime</Highlight>  designed as a drop-in replacement for Node.js. It's written in Zig and powered by JavaScriptCore under the hood, dramatically reducing startup times and memory usage.
