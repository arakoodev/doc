---
title: "arakoo - Serverless, Compression and Cache for GPT & LLM"
desc: "Build Production-ready and Blazing Fast LLM chains on the JVM. Scale using serverless and caching. "
...
=======
  ...
  tab2: 
    ...
    desc: "Java magic!"
    youtube: "ZH86LTfjWtU"
>>>>>>> 34e71c00fb9dde72374a06292cb7f738e925b66d
---
## What is Arakoo?

> **​​Arakoo FlySpring & EdgeChains is still under development.** Use it to speed up your development workflows for LLMs and GPTs or run it in production as serverless functions. # FlyFly
