...
function PricingTable() {
    return (
        <div className="bg-emerald-400 dark:bg-emerald-600 border px-0.5 -mt-8 rounded-[6px]">
                ...
                <div className="dark:bg-neutral-800 bg-white px-8 pt-6 rounded-tr-[4px] rounded-tl-[4px] rounded-tr-[4px] rounded-tl-[4px]">
                    <div className="mb-2 flex items-center gap-2">
                        <div className="flex items-center gap-2">
                            <h3 className="gradient-text-brand-500 dark:gradient-text-brand-100 text-2xl font-normal uppercase flex items-center gap-4 font-mono">Pro</h3>
                        </div>
                    </div>
                    <p className="text-scale-1100 my-4 h-[55px] text-sm border-b dark:border-scale-500 pb-4 lg:pr-20">For production applications with the option to scale.</p>
                        ...
                        <div className="flex flex-col gap-1">
                            <div className="flex items-end gap-2">
                                <div>
                                    ...
                                    <p className="mt-2 gradient-text-scale-500 dark:gradient-text-scale-100 pb-1 text-5xl">$25</p>
                                    <p className="text-scale-900 mt-0.5 text-xs">per month per project</p>
                                    <p className="-mt-2"><span className="bg-brand-500 text-emerald-400 rounded-md bg-opacity-30 py-0.5 px-2 text-xs ">+ usage</span></p>
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="dark:border-scale-400 dark:bg-neutral-800 flex h-full rounded-bl-[4px] rounded-br-[4px] flex-1 flex-col bg-white px-8 py-6 mb-0.5 rounded-bl-[4px] rounded-br-[4px]">
                    <p className="text-scale-1100 text-xs mt-2 mb-4">Everything in the Free plan, plus:</p>
                    <ul role="list" className="text-xs text-scale-1000">
                        <li className="flex items-center py-2 first:mt-0">
                            ...
                            <span className="dark:text-scale-1200 mb-0 ml-3 ">8GB database &amp; 100GB file storage</span>
                        </li>
